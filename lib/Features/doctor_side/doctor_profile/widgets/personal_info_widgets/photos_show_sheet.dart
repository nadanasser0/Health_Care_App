...
// Future<String?> showImagePickerSheet(BuildContext context, String userId) async {
...
//                 await firestoreService.updateDoctorField('imageUrl', imagePath);
//                 await firestoreService.updateUserField('image', imagePath);

//                 UserSession.currentDoctor =
//                     UserSession.currentDoctor!.copyWith(imageUrl: imagePath);
//                 UserSession.currentUser =
//                     UserSession.currentUser!.copyWith(image: imagePath);
              ...
              onTap: () async {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      isDoctor
                          ? 'Doctor profile photo updated successfully'
                          : 'Patient profile photo updated successfully',
                    ),
